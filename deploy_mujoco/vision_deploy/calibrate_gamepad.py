...
"""
游戏手柄校准脚本
用于校准摇杆中位与按钮映射；生成的 JSON 放在本目录 vision_deploy/，
供 deploy_mujoco_vision.py 通过 utils.gamepad_utils 加载。
...
def main():
    ...
    if save_calibration(calibration):
        ...
        print("现在可在 deploy_mujoco_vision.py 中使用该校准文件（配置 gamepad_type 或 gamepad_calibration_file）")
    else:
